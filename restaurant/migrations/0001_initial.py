...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'restaurant_menucategory', (
            ...
            ('start_day', self.gf('django.db.models.fields.CharField')(max_length=2, blank=True)),
            ('end_day', self.gf('django.db.models.fields.CharField')(max_length=2, blank=True)),
        ...
        # Adding model 'FoodChoice'
        db.create_table(u'restaurant_foodchoice', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'restaurant', ['FoodChoice'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'FoodChoice'
        db.delete_table(u'restaurant_foodchoice')
    ...
    models = {
        ...
        u'restaurant.foodchoice': {
            'Meta': {'object_name': 'FoodChoice'},
        ...
        u'restaurant.menucategory': {
            ...
            'description': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'end_day': ('django.db.models.fields.CharField', [], {'max_length': '2', 'blank': 'True'}),
            'end_time': ('django.db.models.fields.TimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'start_day': ('django.db.models.fields.CharField', [], {'max_length': '2', 'blank': 'True'}),
