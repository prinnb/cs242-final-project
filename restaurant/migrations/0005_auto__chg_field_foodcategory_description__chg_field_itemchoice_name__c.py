...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FoodCategory.description'
        db.alter_column(u'restaurant_foodcategory', 'description', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'ItemChoice.name'
        db.alter_column(u'restaurant_itemchoice', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'MenuCategory.description'
        db.alter_column(u'restaurant_menucategory', 'description', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'FoodCategory.description'
        raise RuntimeError("Cannot reverse this migration. 'FoodCategory.description' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'FoodCategory.description'
        db.alter_column(u'restaurant_foodcategory', 'description', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'ItemChoice.name'
        db.alter_column(u'restaurant_itemchoice', 'name', self.gf('django.db.models.fields.IntegerField')())

        # User chose to not deal with backwards NULL issues for 'MenuCategory.description'
        raise RuntimeError("Cannot reverse this migration. 'MenuCategory.description' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'MenuCategory.description'
        db.alter_column(u'restaurant_menucategory', 'description', self.gf('django.db.models.fields.CharField')(max_length=255))
